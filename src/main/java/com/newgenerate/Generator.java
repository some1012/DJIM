...
public class Generator {
    public static void main(String[] args) {
        //1、配置数据源
        FastAutoGenerator.create("jdbc:mysql://localhost:3306/vueadmin", "root", "root")
                //2、全局配置
                .globalConfig(builder -> {
                    builder.author("sor") // 设置作者名
                ...
                .packageConfig(builder -> {
                    builder.parent("com.newgenerate") // 设置父包名
                            .moduleName("")   //设置模块包名
                ...
                .strategyConfig(builder -> {
                    builder.addInclude("sys_menu","sys_role","sys_role_menu","sys_user","sys_user_role") // 设置需要生成的数据表名
//                            .addTablePrefix("sys_") // 设置过滤表前缀
                            ...
                            .logicDeleteColumnName("valid")   //逻辑删除字段名
